	...
	<form class="edit" action="addrisk">
		<table width='600' align="center">
			...
			<tr>
				...
				<td><input type="radio" value="high"
					name="rpos" checked="checked">高 <input type="radio"
					value="medium" name="rpos">中 <input
					type="radio" value="low" name="rpos">低
				</td>
			</tr>
			<tr>
				...
				<td><input type="radio" value="high"
					...
					value="medium" name="reff">中 <input
				...
				<td bgcolor='#FFFFFF'><table width='100%' border='0'
						...
						<s:iterator id="risk" value="risklist" status="st">		
							<tr>
								...
								<td height='20' align='center' valign='middle' bgcolor='#FFFFFF'><s:property value="#risk.riskPossibility"></s:property></td>
								<td height='20' align='center' valign='middle' bgcolor='#FFFFFF'><s:property value="#risk.riskEfficiency"></s:property></td>
